...
Calculate the Tanimoto distance (also known as the Jaccard index). A
value of `1` indicates **no similarity** and a value of `0` indicates
**perfect similarity**.
...
relationship to the number of unique bits present in both samples. In
this case, the Tanimoto Distance is a measure of dissimilarity.
