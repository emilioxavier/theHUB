...
country.DATA <- full_join(x=country.iso, y=SLATE.country.names.2022, by="Name") |>
  full_join(y=country.currencies, by="Alpha_2") |>
  select(Alpha_2:Name.ISO, currency, currency.code, contains("SLATE"))
